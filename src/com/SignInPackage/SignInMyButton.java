...
public class SignInMyButton extends JButton {
    //判断类的serialVersionUID来验证版本一致性的
    private static final long serialVersionUID = 39082560987930759L;


    //默认颜色 两种渐变色
    private Color BUTTON_COLOR1 = new Color(0x9575cd);
    private Color BUTTON_COLOR2 = new Color(0xc7a4ff);
    ...
    //按下按钮时字体的默认颜色
    private Color BUTTON_FOREGROUND_COLOR1 = new Color(0xb4004e);
    ...
    public SignInMyButton(ImageIcon icon) {
        setIcon(icon);
        Init();
    }
    public SignInMyButton(String name) {
        setText(name);
        Init();
    }
